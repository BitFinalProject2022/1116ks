...
public class ClosetController {
    ...
    @ResponseBody
    public List<ClosetVo> selectImagePath(@RequestParam(value = "small_category_code") int smallCategoryCode,
                    Principal principal) {
        ...
        imagePathList = closetService.imagePathList(smallCategoryCode, longId);
